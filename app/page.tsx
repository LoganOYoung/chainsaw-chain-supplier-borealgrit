      ...
      <main>
        ...
        <section className="relative w-full h-[50vh] min-h-[400px] md:h-[60vh] md:min-h-[500px] max-h-[700px]">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center py-8 md:py-0">
            ...
            <Link
              href="/request-quote"
              className="inline-flex items-center gap-2 px-6 py-3 md:px-10 md:py-5 bg-forest-brand text-white font-bold text-base md:text-xl hover:bg-forest-brand/90 transition shadow-2xl rounded-none transform hover:scale-105 w-fit"
            >
              Request a Quote
        ...
        <section className="bg-white py-8 md:py-12 lg:py-16 border-b border-forest-brand/30">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mt-6 md:mt-8">
              <Link
                href="/quality"
                className="inline-flex items-center gap-2 px-5 py-2.5 md:px-6 md:py-3 bg-forest-brand text-white font-semibold text-xs sm:text-sm hover:bg-forest-brand/90 transition rounded-none shadow-sm"
              >
