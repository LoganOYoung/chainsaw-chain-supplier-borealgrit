      ...
      <main>
        ...
        <section className="relative w-full h-[60vh] min-h-[500px] max-h-[700px]">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
            ...
            <Link
              href="/request-quote"
              className="inline-flex items-center gap-2 px-10 py-5 bg-forest-brand text-white font-bold text-xl hover:bg-forest-brand/90 transition shadow-2xl rounded-none transform hover:scale-105 w-fit"
            >
              Request a Quote
        ...
        <section className="bg-white py-12 md:py-16 border-b border-forest-brand/30">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="font-heading text-2xl md:text-3xl font-bold text-text-main mb-3 text-center tracking-tight uppercase">
              How It Works
            </h2>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="bg-gray-50 border-2 border-forest-brand rounded-none p-6 text-center">
        ...
        <section className="bg-gray-50 border-b border-forest-brand/30 py-8">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div>
                <p className="text-sm font-semibold text-text-main mb-1">ANSI B175.1 / CSA Z62.3</p>
                <p className="text-xs text-text-body">Safety Standards Compliant</p>
              </div>
              <div>
                <p className="text-sm font-semibold text-text-main mb-1">ISO 9001:2015</p>
                <p className="text-xs text-text-body">Quality Management Certified</p>
              </div>
              <div>
                <p className="text-sm font-semibold text-text-main mb-1">OEM & Private Label</p>
                <p className="text-xs text-text-body">Custom Manufacturing</p>
              </div>
              <div>
                <p className="text-sm font-semibold text-text-main mb-1">24-Hour Response</p>
        ...
        <section className="bg-white py-10 border-b border-forest-brand/30">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="font-heading text-lg md:text-xl font-bold text-text-main mb-6 text-center tracking-tight uppercase">Compatible with Leading Brands</h2>
        ...
        <section className="bg-forest-brand py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="font-heading text-2xl md:text-3xl font-bold text-white mb-8 text-center uppercase tracking-tight">
              Why Professional Importers Choose Us
            </h2>
            <div className="space-y-6">
              <div className="pb-6 border-b border-white/20 last:border-b-0">
        ...
        <section className="bg-white py-12 md:py-16 border-b border-forest-brand/30">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-sm text-text-body text-center mb-8 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-gray-50 border border-forest-brand/30 rounded-none p-6 text-center">
