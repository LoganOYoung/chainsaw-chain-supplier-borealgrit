            ...
            <table className="w-full min-w-[500px] text-sm border border-forest-brand/30">
              ...
              <tbody className="text-industrial">
                <tr className="border-t border-forest-brand/30">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex flex-col gap-2">
                      <button onClick={downloadCatalogCSV} className="inline-flex items-center gap-1 text-forest-brand font-medium hover:bg-forest-brand hover:text-white hover:px-2 hover:py-1 hover:-mx-2 hover:-my-1 hover:border-2 hover:border-forest-brand transition text-left">
                ...
                <tr className="border-t border-forest-brand/30">
                  ...
                  <td className="px-4 py-3">
                    <button onClick={generateQuickReferenceGuide} className="inline-flex items-center gap-1 text-forest-brand font-medium hover:bg-forest-brand hover:text-white hover:px-2 hover:py-1 hover:-mx-2 hover:-my-1 hover:border-2 hover:border-forest-brand transition text-left">
                      <Download className="w-4 h-4" />
                      Download PDF
                    </button>
                  </td>
            ...
            <table className="w-full min-w-[500px] text-sm border border-forest-brand/30">
              ...
              <tbody className="text-industrial">
                <tr className="border-t border-forest-brand/30">
                  ...
                  <td className="px-4 py-3">
                    <button onClick={generateFC325Datasheet} className="inline-flex items-center gap-1 text-forest-brand font-medium hover:bg-forest-brand hover:text-white hover:px-2 hover:py-1 hover:-mx-2 hover:-my-1 hover:border-2 hover:border-forest-brand transition text-left">
                      <Download className="w-4 h-4" />
                      Download PDF
                    </button>
                  </td>
                ...
                <tr className="border-t border-forest-brand/30">
                  ...
                  <td className="px-4 py-3">
                    <button onClick={generateSC38Datasheet} className="inline-flex items-center gap-1 text-forest-brand font-medium hover:bg-forest-brand hover:text-white hover:px-2 hover:py-1 hover:-mx-2 hover:-my-1 hover:border-2 hover:border-forest-brand transition text-left">
                      <Download className="w-4 h-4" />
                      Download PDF
                    </button>
                  </td>
                ...
                <tr className="border-t border-forest-brand/30">
                  ...
                  <td className="px-4 py-3">
                    <button onClick={generateLP325Datasheet} className="inline-flex items-center gap-1 text-forest-brand font-medium hover:bg-forest-brand hover:text-white hover:px-2 hover:py-1 hover:-mx-2 hover:-my-1 hover:border-2 hover:border-forest-brand transition text-left">
                      <Download className="w-4 h-4" />
                      Download PDF
                    </button>
                  </td>
            ...
            <table className="w-full min-w-[500px] text-sm border border-forest-brand/30">
              ...
              <tbody className="text-industrial">
                <tr className="border-t border-forest-brand/30">
                  ...
                  <td className="px-4 py-3">
                    <button onClick={generateFitmentGuide} className="inline-flex items-center gap-1 text-forest-brand font-medium hover:bg-forest-brand hover:text-white hover:px-2 hover:py-1 hover:-mx-2 hover:-my-1 hover:border-2 hover:border-forest-brand transition text-left">
                      <Download className="w-4 h-4" />
                      Download PDF
                    </button>
                  </td>
                ...
                <tr className="border-t border-forest-brand/30">
                  ...
                  <td className="px-4 py-3">
                    <button onClick={generatePitchGaugeGuide} className="inline-flex items-center gap-1 text-forest-brand font-medium hover:bg-forest-brand hover:text-white hover:px-2 hover:py-1 hover:-mx-2 hover:-my-1 hover:border-2 hover:border-forest-brand transition text-left">
                      <Download className="w-4 h-4" />
                      Download PDF
                    </button>
                  </td>
            ...
            <table className="w-full min-w-[500px] text-sm border border-forest-brand/30">
              ...
              <tbody className="text-industrial">
                <tr className="border-t border-forest-brand/30">
                  ...
                  <td className="px-4 py-3">
                    <button onClick={generateBuyersGuide} className="inline-flex items-center gap-1 text-forest-brand font-medium hover:bg-forest-brand hover:text-white hover:px-2 hover:py-1 hover:-mx-2 hover:-my-1 hover:border-2 hover:border-forest-brand transition text-left">
                      <Download className="w-4 h-4" />
                      Download PDF
                    </button>
                  </td>
                ...
                <tr className="border-t border-forest-brand/30">
                  ...
                  <td className="px-4 py-3">
                    <button onClick={generateFAQDocument} className="inline-flex items-center gap-1 text-forest-brand font-medium hover:bg-forest-brand hover:text-white hover:px-2 hover:py-1 hover:-mx-2 hover:-my-1 hover:border-2 hover:border-forest-brand transition text-left">
                      <Download className="w-4 h-4" />
                      Download PDF
                    </button>
                  </td>
