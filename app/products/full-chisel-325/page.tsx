...
export const metadata: Metadata = {
  title: 'FC-325 Full Chisel .325" Chainsaw Chain | ChainPro',
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        ...
        <section className="mb-10">
          <div className="relative w-full h-64 md:h-96 lg:h-[500px] rounded-none overflow-hidden bg-gray-100">
            <Image
              src="/images/products/full-chisel-325-hero.jpg"
              alt="Full Chisel .325 inch chainsaw chain in professional logging application - cutting clean wood with square-corner cutters"
              fill
        ...
        {/* Product Detail Images - Cutter Profile */}
        <section className="mb-10">
          <h2 className="text-lg font-bold text-text-main mb-4 border-b border-forest-brand/30 pb-2">Cutter Profile & Design</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="relative w-full h-48 md:h-64 rounded-none overflow-hidden bg-gray-50">
              <Image
                src="/images/products/full-chisel-cutter-detail.jpg"
                alt="Full-Chisel square-corner cutter close-up showing razor-sharp square corners for maximum cutting speed"
                fill
                className="object-cover"
                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 33vw, 400px"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-green-800/70 text-white p-3">
                <p className="text-sm font-semibold">Square-Corner Cutter</p>
                <p className="text-xs text-gray-200">Razor-sharp geometry</p>
              </div>
            </div>
            <div className="relative w-full h-48 md:h-64 rounded-none overflow-hidden bg-gray-50">
              <Image
                src="/images/products/full-chisel-chain-detail.jpg"
                alt="Full-Chisel chain assembly showing cutter spacing and drive link configuration"
                fill
                className="object-cover"
                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 33vw, 400px"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-green-800/70 text-white p-3">
                <p className="text-sm font-semibold">Chain Assembly</p>
                <p className="text-xs text-gray-200">.325 inch pitch configuration</p>
              </div>
            </div>
            <div className="relative w-full h-48 md:h-64 rounded-none overflow-hidden bg-gray-50">
              <Image
                src="/images/products/full-chisel-application.jpg"
                alt="Full-Chisel chain cutting clean softwood - optimal application for professional logging"
                fill
                className="object-cover"
                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 33vw, 400px"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-green-800/70 text-white p-3">
                ...
                <p className="text-xs text-gray-200">Clean wood cutting</p>
              </div>
            </div>
          </div>
