...
export const metadata: Metadata = {
  title: 'OEM & Private Label Chainsaw Chains | Custom Manufacturing | ChainPro',
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        ...
        <section className="bg-accent/5 border-2 border-forest-brand rounded-none p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/request-quote"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-safety-orange text-white font-semibold text-sm hover:bg-safety-orange/90 transition rounded"
            >
